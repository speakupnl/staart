...
export enum ErrorCode {
  NOT_FOUND = "404/not-found__SAFE__",
  MISSING_TOKEN = "422/missing-token__SAFE__",
  REVOKED_TOKEN = "401/revoked-token__SAFE__",
  INVALID_TOKEN = "401/invalid-token__SAFE__",
  EXPIRED_TOKEN = "401/expired-token__SAFE__",
  MISSING_PRIMARY_EMAIL = "422/missing-primary-email__SAFE__",
  MISSING_PASSWORD = "422/missing-password__SAFE__",
  MISSING_FIELD = "422/missing-field__SAFE__",
  INVALID_INPUT = "422/invalid-input__SAFE__",
  EMAIL_EXISTS = "422/email-exists__SAFE__",
  USERNAME_EXISTS = "422/username-exists__SAFE__",
  USER_NOT_FOUND = "404/user-not-found__SAFE__",
  MEMBERSHIP_NOT_FOUND = "404/membership-not-found__SAFE__",
  ORGANIZATION_NOT_FOUND = "404/organization-not-found__SAFE__",
  SUBSCRIPTION_NOT_FOUND = "404/subscription-not-found__SAFE__",
  INVOICE_NOT_FOUND = "404/invoice-not-found__SAFE__",
  INVALID_LOGIN = "401/invalid-login__SAFE__",
  INCORRECT_PASSWORD = "401/incorrect-password__SAFE__",
  INSUFFICIENT_PERMISSION = "403/insufficient-permission__SAFE__",
  DEFAULT = "500/server-error__SAFE__",
  EMAIL_CANNOT_DELETE = "400/cannot-delete-email__SAFE__",
  UNVERIFIED_EMAIL = "401/unverified-email__SAFE__",
  GOOGLE_AUTH_ERROR = "401/google-auth-error__SAFE__",
  UNAPPROVED_LOCATION = "401/unapproved-location__SAFE__",
  CANNOT_DELETE_SOLE_OWNER = "400/cannot-delete-sole-owner__SAFE__",
  CANNOT_UPDATE_SOLE_OWNER = "400/cannot-update-sole-owner__SAFE__",
  USER_IS_MEMBER_ALREADY = "400/user-is-member-already__SAFE__",
  STRIPE_NO_CUSTOMER = "404/no-customer__SAFE__",
  NOT_ENABLED_2FA = "400/invalid-2fa-token__SAFE__",
  INVALID_2FA_TOKEN = "401/invalid-2fa-token__SAFE__",
  OAUTH_NO_NAME = "422/oauth-no-name__SAFE__",
  OAUTH_NO_EMAIL = "404/oauth-no-email__SAFE__",
  INVALID_API_KEY_SECRET = "401/invalid-api-key-secret__SAFE__",
  IP_RANGE_CHECK_FAIL = "401/ip-range-check-fail__SAFE__",
  REFERRER_CHECK_FAIL = "401/referrer-check-fail__SAFE__",
  DISPOSABLE_EMAIL = "422/disposable-email__SAFE__",
  DOMAIN_UNABLE_TO_VERIFY = "400/domain-unable-to-verify__SAFE__",
  DOMAIN_MISSING_FILE = "400/domain-missing-file__SAFE__",
  DOMAIN_MISSING_DNS = "400/domain-missing-dns__SAFE__",
  DOMAIN_ALREADY_VERIFIED = "400/domain-already-verified__SAFE__",
  CANNOT_INVITE_DOMAIN = "400/cannot-invitedomain__SAFE__"
}
